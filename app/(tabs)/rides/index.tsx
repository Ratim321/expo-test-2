...
export default function RidesScreen() {
  ...
  const handleJoinRide = (ride) => {
    showToast(`You've joined the ride to ${ride.to}!`, 'success');
    // In a real app, this would update the database
  };

  const openRideChat = (ride) => {
    // Navigate to the chat screen with ride details
    const rideName = `${ride.from} to ${ride.to}`;
    const currentUserId = 'user123'; // In a real app, this would be the authenticated user's ID
    const currentUserName = 'John Doe'; // In a real app, this would be the authenticated user's name
    const currentUserAvatar = 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80'; // In a real app, this would be the authenticated user's avatar
